...
class DownloadTestCase(unittest.TestCase):
    ...
    def test_download_url(self, mock):
        ...
        try:
            main(
                [
                    'download',
                    'https://api.pgxn.org/dist/foobar/0.43.2b1/foobar-0.43.2b1.zip',
                ]
            )
            self.assert_(os.path.exists(fn))
        finally:
    ...
    def test_version(self):
        ...
        for spec, res, data in [
            ...
            self.assertRaises(
                ResourceNotFound, cmd.get_best_version, data, spec
            )
...
class InstallTestCase(unittest.TestCase, Assertions):
    def setUp(self):
        ...
        self.mock_pgconfig.side_effect = fake_pg_config(libdir='/', bindir='/')
    ...
    def test_install_local(self):
        ...
        self.assertCallArgs(
            [self.make], self.mock_popen.call_args_list[1][0][0][:1]
        )
    ...
    def test_install_bad_sha1(self):
        ...
        self.assertRaises(
            BadChecksum, main, ['install', '--sudo', '--', 'foobar']
        )
    ...
    def test_install_sudo(self):
        ...
        self.assertCallArgs(
            ['gksudo', '-d', 'hello world', self.make],
...
class LoadTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self._p3 = patch(
            'pgxnclient.commands.install.LoadUnload.get_pg_version'
        )
    ...
    def test_load_tar_url(self, mock_get, mock_unpack):
        ...
        main(['load', '--yes', 'https://example.org/foobar-0.42.1.tar.gz'])
    ...
    def test_load_extensions_order(self):
        ...
        communicate = self.mock_popen.return_value.communicate
        self.assertEquals(
            communicate.call_args_list[0][0][0], b'CREATE EXTENSION foo;'
        )
        self.assertEquals(
            communicate.call_args_list[1][0][0], b'CREATE EXTENSION bar;'
        )
        self.assertEquals(
            communicate.call_args_list[2][0][0], b'CREATE EXTENSION baz;'
        )
        self.assertEquals(
            communicate.call_args_list[3][0][0], b'CREATE EXTENSION qux;'
        )
    ...
    def test_unload_extensions_order(self):
        ...
        communicate = self.mock_popen.return_value.communicate
        self.assertEquals(
            communicate.call_args_list[0][0][0], b'DROP EXTENSION qux;'
        )
        self.assertEquals(
            communicate.call_args_list[1][0][0], b'DROP EXTENSION baz;'
        )
        self.assertEquals(
            communicate.call_args_list[2][0][0], b'DROP EXTENSION bar;'
        )
        self.assertEquals(
            communicate.call_args_list[3][0][0], b'DROP EXTENSION foo;'
        )
    ...
    def test_unload_list(self):
        ...
        communicate = self.mock_popen.return_value.communicate
        self.assertEquals(
            communicate.call_args_list[0][0][0], b'DROP EXTENSION baz;'
        )
        self.assertEquals(
            communicate.call_args_list[1][0][0], b'DROP EXTENSION foo;'
        )
    ...
    def test_load_missing(self):
        ...
        try:
            ...
            self.assertRaises(
                PgxnClientException, main, ['load', '--yes', dir, 'foo', 'ach']
            )
